                            ...
                            <div class="app-search-box dropdown">
                                ...
                                <div class="dropdown-menu dropdown-lg" id="search-dropdown">
                                    ...
                                    <div class="notification-list">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="media">
                                                <img class="d-flex mr-2 rounded-circle" src="<?= base_url() ?>/assets/images/users/user-2.jpg" alt="Generic placeholder image" height="32">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="media">
                                                <img class="d-flex mr-2 rounded-circle" src="<?= base_url() ?>/assets/images/users/user-5.jpg" alt="Generic placeholder image" height="32">
                                                <div class="media-body">
                        ...
                        <div class="dropdown-menu dropdown-lg dropdown-menu-right">
                            ...
                            <div class="p-lg-1">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="<?= base_url() ?>/assets/images/brands/g-suite.png" alt="G Suite">
                                            <span>G Suite</span>
                                        </a>
                                    </div>
